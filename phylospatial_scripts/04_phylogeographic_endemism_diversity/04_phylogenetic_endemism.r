# this script calculates richness and endemism from modeled suitability surfaces
# it requires all the model grids to have the same extent
# the original script is available in https://github.com/DanRosauer/phylospatial/tree/master/LineageModels/
